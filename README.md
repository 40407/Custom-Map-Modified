...
| 序号<br>#为精选地图 | 英文名称<br>$\color{green}{绿色为zm基础上修改}$ | 中文翻译<br>$\color{blue}{蓝色为改动了vpk}$ | 备注 | 
|---------------------|--------------------------------------------------|----------------------------------------------|------|
| #1 | 2 Evil Eyes | 邪恶双眸 | |
| 2 | $\color{green}{Arena\ of\ the\ Dead\ 2}$ | 尸骸竞技场2 | 修改路程和坦克 |
| #3 | Crash Course: Rerouted | 坠机险途：改航 | m1路程300改为400，m3删包 |
| #4 | $\color{green}{Dam\ it\ 2!\ The\ Director's\ Cut}$ | 大坝2：导演剪辑版 | 修复zm原有bug |
| 5 | Early Days | 末日初兆 | 还没有正式实装 |
...
| 3 | Dead Air Redux AW | 静寂时分：殊途 | 场景塑造差 | ⭐⭐⭐ |
...
| 14 | ~~Buenos Aires~~ | $\color{blue}{布宜诺斯艾利斯}$ | 删去m1和救援 | ⭐⭐⭐ |
| 15 | ~~Deathcraft Ⅱ~~ | $\color{blue}{死的世界2}$ | 删去救援，生还特感恢复原模 | ⭐⭐⭐ |
| 16 | ~~Devil Mountain~~ | $\color{blue}{邪魔山岳}$ | 删去救援 | ⭐⭐⭐ |
| 17 | ~~Dry County~~ | $\color{blue}{风沙之郡}$ | 没有爬行轨迹 | ⭐⭐⭐ |
| 18 | ~~No Mercy APOCALYPSE~~ | $\color{blue}{毫不留情：启示录}$ | 删去救援 | ⭐⭐⭐ |
| 19 | ~~No Mercy Xmas~~ | $\color{blue}{毫不留情：圣诞节}$ | 删去m1，m7和m8 | ⭐⭐⭐ |
| 20 | ~~Nova Prospekt~~ | $\color{blue}{诺瓦矿场}$ | 没有爬行轨迹， $\color{red} {救援不算分}$；删去m3,m6 | ⭐⭐⭐ |
| 21 | ~~One Four Nine~~ | $\color{blue}{古墓亡影}$ | 修改路程和坦克，修复zm原有bug，删除m5滤镜 | ⭐⭐⭐ |
| 22 | ~~Plague Tale~~ | $\color{blue}{瘟疫传说}$ | 没有爬行轨迹 | ⭐⭐⭐ |
